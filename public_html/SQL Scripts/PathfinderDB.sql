...
RACE_SPEED       CHAR(2)  NOT NULL,
RACE_SIGHT       CHAR(20) NOT NULL,
RACE_LANGUAGE    CHAR(50) NOT NULL,
RACE_SELECT_ATTR CHAR(1)  NOT NULL,
RACE_STR         CHAR(2)  NOT NULL,
RACE_DEX         CHAR(2)  NOT NULL,
RACE_CON         CHAR(2)  NOT NULL,
RACE_INT         CHAR(2)  NOT NULL,
RACE_WIS         CHAR(2)  NOT NULL,
RACE_CHA         CHAR(2)  NOT NULL,
CONSTRAINT race_pk
